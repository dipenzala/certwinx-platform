...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'Our experts review your current processes, documentation and readiness — and identify what needs to be prepared.',
...
export default function ProcessCertification() {
